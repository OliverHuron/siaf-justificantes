...
const I = {
  ...
  usuarios: <path d="M9 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM2 21c0-3.3 3.1-6 7-6s7 2.7 7 6M16 3.1a4 4 0 0 1 0 7.8M22 21c0-2.8-2.3-5.2-5.5-5.8" />,
};
    ...
    <div className="shell">
      <aside className="shell-side">
        ...
        <nav>
          ...
          {esSup && <NavLink to="/staff/usuarios" className={link}><Ic d={I.usuarios} />Usuarios</NavLink>}
        </nav>
